package com.solvenyang.backgrounds.repository;

import com.solvenyang.backgrounds.domain.Background;
import com.solvenyang.backgrounds.dto.BackgroundQueryResult;
...
public interface BackgroundRepository extends JpaRepository<Background, Long> {
    ...
    @Query("SELECT new com.solvenyang.backgrounds.dto.BackgroundQueryResult(" +
            "b.id, "+
            "b.name, " +
            "COUNT(ob) > 0 )" +
            "FROM Background b " +
